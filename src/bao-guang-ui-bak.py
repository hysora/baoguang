...
# pyinstaller --onedir --windowed --add-data "bao-guang.py;." --collect-all playwright --hidden-import openpyxl --hidden-import openpyxl.styles --hidden-import winreg --name "曝光量抓取工具" bao-guang-ui.py
